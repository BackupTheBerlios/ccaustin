...
<xsl:template match="messagecatalog">
    <TABLE cellspacing="3" cellpadding="2" BACKGROUND="../images/bgbo.gif" BORDER="0" WIDTH="100%">
    <TR>
    <TD>
    ...
    <TD BACKGROUND="">
        The Bible Overview tapes are part of an ongoing overview of chapters of a specific book.
    ...
    <TR>
        ...
        <TD>
        <xsl:call-template name="msgCatTapeListNS">
            <xsl:with-param name="pcategorytitle" select="'Bible Overview'"/>
            <xsl:with-param name="pcategory" select = "'overview'"/>
