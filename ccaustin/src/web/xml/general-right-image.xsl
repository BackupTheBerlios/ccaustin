...
<!--
	...
	Extends the general-ui.xsl template to provide a small right sidebar that can contain
	one image with the rest of the space occupied with the content on the left.
	...
	<xsl:include href="../general-right-image.xsl"/>
	
	$Id: general-right-image.xsl,v 1.1 2002/01/31 03:25:33 javajames27 Exp $
-->
...
<!-- include the base XSL templates -->
