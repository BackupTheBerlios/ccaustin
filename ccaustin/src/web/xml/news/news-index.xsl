...
<!-- 
	...
	$Id: news-index.xsl,v 1.1 2002/07/08 21:42:47 javajames27 Exp $
...
<xsl:template match="news-index">
	<xsl:for-each select="document('news?.xml')/content">
		<xsl:text>Found 1</xsl:text>
