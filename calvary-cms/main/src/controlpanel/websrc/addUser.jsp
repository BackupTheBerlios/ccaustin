...
<html:html locale='true'>
  <slide:namespace id='namespace'>
    ...
    <head>
      <title><bean:message key="app.title"/>: <bean:message key="users.title"/> - <bean:message key="addUser.title"/></title>
        ...
        <tr>
          ...
          <td class='content' align='left' valign='top' width='100%' height='100%'>
            ...
            <html:form action='/addUser' focus='username' styleClass='dialog'>
              <h3 class='headline'><font color='#555576' size='2'><bean:message key="addUser.title"/></font></h3>
              <hr>
              <table border='0'>
                <tr>
                ...
                <tr>
                  ...
                  <td align='left' valign='middle'>
                    ...
                    <span class='dialogLabel'><bean:message key='userForm.label.rootRole'/></span>
                  </td>
                </tr>
                <tr>
